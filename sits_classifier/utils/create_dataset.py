...
DATA_DIR = os.path.join(PATH, 'pxl04_balanced_buffered_reshapeeed_nonstandardized_species')
...
if __name__ == "__main__":
    ...
    np.save('/media/j/d56fa91a-1ba4-4e5b-b249-8778a9b4e904/data/x_set_pxl_buffered_balanced_nonstan_species_season.npy', x_data_season)
    np.save('/media/j/d56fa91a-1ba4-4e5b-b249-8778a9b4e904/data/x_set_pxl_buffered_balanced_nonstan_species_years.npy', x_data_years)
