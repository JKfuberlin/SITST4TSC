...
# # settings
PATH=('/media/jonathan/d56fa91a-1ba4-4e5b-b249-8778a9b4e904/data/')
DATA_DIR = os.path.join(PATH, 'objectbased_data/')
LABEL_CSV = 'multilabels_qnd.csv'
...
if __name__ == "__main__":
    ...
    torch.save(x_set, '/media/jonathan/d56fa91a-1ba4-4e5b-b249-8778a9b4e904/data/x_set_obj.pt')
    torch.save(y_set, '/media/jonathan/d56fa91a-1ba4-4e5b-b249-8778a9b4e904/data/y_set_pixelbased.pt')
